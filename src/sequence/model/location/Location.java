...
public class Location {
	 ...
	 *            the new operatingtheatre
	 */
	public void setOperatingtheatre(final Operatingtheatre operatingtheatre) {
	...
	public String toXML() {
		...
		final StringBuilder sb = new StringBuilder("<rec_location>" + NEW_LINE);
		if (city != null)
