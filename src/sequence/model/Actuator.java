...
public class Actuator {
	 ...
	 * 
	 * @param usedbodypart
	 *            the new usedbodypart
	 */
	public void setUsedbodypart(final BodyPart usedbodypart) {
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof Actuator))
			return false;
		return (position.equals(((Actuator) o).position) && usedbodypart
				.equals(((Actuator) o).usedbodypart));
	}
	...
	public String toXML() {
		...
		final StringBuilder sb = new StringBuilder("<actuator>" + NEW_LINE);
		if (position != null)
