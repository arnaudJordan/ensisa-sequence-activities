...
public class Participant {
	 ...
	 *            the new clinical degree
	 */
	public void setClinicalDegree(final ClinicalDegree clinicalDegree) {
	 ...
	 *            the new academic degree
	 */
	public void setAcademicDegree(final AcademicDegree academicDegree) {
	 ...
	 * @return true, if successful
	 */
	public boolean add(final Actor e) {
		return actors.add(e);
	}
	...
	public String toXML() {
		...
		final StringBuilder sb = new StringBuilder("<participant>" + NEW_LINE);
		if (position != null)
